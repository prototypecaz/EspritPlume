...
if (
    ...
    $connexionBdd->getData("UPDATE `produits` SET `titre` = (:titre),`description` = (:description),`image` = (:image),`prix` = (:prix),`quantite` = (:quantite),`id_categorie` = (:idCategorie),`id_marque` = (:idMarque) WHERE `produits`.`id` = (:idProduit)",
     [':titre' => $titreArticle,
     ':description' => $description,
     ':image' => $UPLOADS_BDD.$image,
     ':prix' => $prix,
     ':quantite' => $quantite,
