...
$UPLOADS = (string) '/var/www/html/boutique/assets/img/uploads/';
...
if (
    ...
    isset($_POST['quantite']) and !empty($_POST['quantite']) and strlen($_POST['quantite']) <= 2 
) {
   ...
   //////////////////////////////////////////////////////////////////////////
    ...
    $connexionBdd->getData("INSERT INTO `produits` (`id`, `titre`, `description`, `image`, `prix`, `quantite`, `id_categorie`, `id_marque`) VALUES (NULL,(:titre),(:description),(:image),(:prix),(:quantite),(:idCategorie),(:idMarque));",
    [':titre' => $titreArticle,':description' => $description,':image' => $UPLOADS_BDD.$image,':prix' => $prix,':quantite' => $quantite,':idCategorie' => $idCategorie,':idMarque' => $idMarque]);
